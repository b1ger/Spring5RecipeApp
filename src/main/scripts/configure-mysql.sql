...
CREATE USER  'sfg_dev_user'@'localhost' IDENTIFIED BY 'ontario';
CREATE USER  'sfg_prod_user'@'localhost' IDENTIFIED BY 'ontario';
CREATE USER  'sfg_dev_user'@'%' IDENTIFIED BY 'ontario';
CREATE USER  'sfg_prod_user'@'%' IDENTIFIED BY 'ontario';
